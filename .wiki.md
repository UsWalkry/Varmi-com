# Project Summary
The "Var mı?" project is a reverse marketplace platform tailored for the Turkish market, where buyers can post their needs and sellers can respond with offers. It features a secure escrow payment system to streamline transactions and enhance user communication. Recent updates have focused on optimizing the user experience by addressing performance issues and refining core functionalities.

# Project Module Description
The application consists of several functional modules:
- **User Management**: Handles user registration, login, and profile settings.
- **Listing Management**: Supports the creation, viewing, and management of listings.
- **Offer Management**: Enables sellers to submit offers and buyers to review them.
