        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="mt-12">
            <Tabs defaultValue="desc" className="w-full">
              <TabsList className="sticky top-0 z-10 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b w-full flex flex-nowrap gap-8 overflow-x-auto md:grid md:grid-cols-5 md:gap-0 md:overflow-visible">
                <TabsTrigger
                  value="desc"
                  className="px-3 md:px-4 pb-3 text-sm sm:text-base font-medium text-muted-foreground hover:text-foreground border-b-2 border-transparent data-[state=active]:text-foreground data-[state=active]:border-orange-500 truncate justify-start md:justify-center shrink-0"
                >
                  Ürün Açıklaması
                </TabsTrigger>
                <TabsTrigger
