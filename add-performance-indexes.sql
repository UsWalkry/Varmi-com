...
CREATE INDEX IF NOT EXISTS idx_offers_status_approval 
...
CREATE INDEX IF NOT EXISTS idx_commission_user 
ON commission_transactions(user_id);

-- Transaction type (earned/withdrawn)
CREATE INDEX IF NOT EXISTS idx_commission_type 
ON commission_transactions(transaction_type);

-- Created_at sıralama
CREATE INDEX IF NOT EXISTS idx_commission_created 
